 ...
 */
package com.english.storm.autoscrollviewpager.viewpagerindicator;
...
import com.english.storm.autoscrollviewpager.R;
...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float offsetPercent;
        float pageOffsetMax = 0.5f;
        if (mPageOffset <= pageOffsetMax) {
