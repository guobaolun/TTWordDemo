...
package com.english.storm.widget.wheelview;
...
import com.english.storm.widget.wheelview.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
    private int[] shadowsColors = new int[]{0xefE9E9E9, 0xcfE9E9E9, 0x3fE9E9E9};
...
//				notifyChangingListeners(old, currentItem);
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        // 绘制下边直线
        canvas.drawLine(0, center + offset - 2, getWidth(), center + offset - 2, paint);
        //*/
    }
